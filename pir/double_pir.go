...
func (pi *DoublePIR) MyInit(info DBinfo, p Params) State { //not implemented yet!
	return MakeState()
}
...
func (pi *DoublePIR) MySetup(DB *Database, shared State, p Params) (State, Msg) { //not implemented yet!

	return MakeState(), MakeMsg()
}
...
func (pi *DoublePIR) MyRecover(i []uint64, batch_index uint64, offline Msg, query Msg,
	answer Msg, shared State, client State, p Params, info DBinfo) []uint64 {
	return []uint64{}
}
